...
public class Identfy {
	...
	private xyz.btpink.w.vo.IdentfyVO identfy;
	

	public TreeMap<String, xyz.btpink.w.vo.IdentfyVO> identfy(ArrayList<String> array) {
		HttpClient httpClient = new DefaultHttpClient();
		TreeMap<String, xyz.btpink.w.vo.IdentfyVO> map = new TreeMap<>();
		try {
			...
			request.setHeader("Ocp-Apim-Subscription-Key", "a3b2643bceee45c89a8f16f4457bf8b1");
